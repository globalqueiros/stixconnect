...
export default function AcupunturaDashboard() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Dashboard - Acupuntura</h1>
              ...
              {atendimentos.map((atendimento) => (
                <div key={atendimento.id} className="border rounded-lg p-4 hover:bg-gray-50 transition">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href={`/acupuntura/atendimento/${atendimento.id}`}
